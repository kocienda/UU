...
TEST_CASE( "TextRef parsing function 1", "[textref]" ) {
    ...
    REQUIRE(t.line() == 285);
    REQUIRE(t.spread() == Spread<size_t>(5,8));
...
TEST_CASE( "TextRef parsing function 6", "[textref]" ) {
    ...
    REQUIRE(t.line() == 285);
    REQUIRE(t.column() == 10);
    REQUIRE(t.spread() == Spread<size_t>(10));
    REQUIRE(t.message() == "33 std::string");
}
...
TEST_CASE( "TextRef parsing function 7", "[textref]" ) {
    ...
    REQUIRE(t.line() == 285);
    REQUIRE(t.column() == 10);
    REQUIRE(t.spread() == Spread<size_t>(10, 14));
    REQUIRE(t.message() == "33 std::string");
}
...
TEST_CASE( "TextRef parsing function 8", "[textref]" ) {
    ...
    REQUIRE(t.line() == 291);
    REQUIRE(t.column() == 42);
    REQUIRE(t.spread() == Spread<size_t>(42, 48));
...
TEST_CASE( "TextRef parsing function 9", "[textref]" ) {
    ...
    REQUIRE(t.line() == 291);
    REQUIRE(t.column() == 42);
    REQUIRE(t.spread() == Spread<size_t>("42..48,56"));
    REQUIRE(t.message() == "                std::string str = ref.to_string()");
}
